            ...
            <div class="container-fluid">
                <div>
                    <div class="tes" style="display:flex; margin-top:20px; align-items:center;">
                        <div style="width:80px; height:80px; background:cyan;border-radius:50%; margin-bottom:10px;">
                            <i style="font-size:70px; color:black; margin:5px 0 0 5px;" class="la la-suitcase"></i>
                        </div>
                        <h1 style="margin-left:15px;">Dashboard User Arsipel</h1>
                    </div>
                </div>
                <div class="row">
