                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Laporan Cetak Pindah</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Perpidahan</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Pindah</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div style="margin:5px 0 5px 60px;">
                                <form method="get" action="lap_pindah.php">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['izin'])) // Jika user mengisi izin tanggal, maka munculkan tombol untuk reset izin
                                        echo '<a href="lap_pindah.php" style="padding:9px; background-color:#ff6e00; color:#fff; border-radius:6px; margin-left:18px;"><b>RESET</b></a>';
                                    ?>
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    $url_cetak = 'print_lap_pindah.php';
                                    $label = "Semua Data Transaksi";
                                } else { // Jika terisi
                                    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                                    $query = "SELECT * FROM pindah WHERE (tanggal BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
                                    $url_cetak = "print_lap_pindah.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
                                            ...
                                            <tbody>
                                                ...
                                                if ($row > 0) { // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                                                    while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
                                                        ...
                                                        echo "<tr>";
                                                        echo "<td>" . $data['nomor_pindah'] . "</td>";
                                                        echo "<td>" . $data['nik'] . "</td>";
                                                        echo "<td>" . $data['nama_pemohon'] . "</td>";
                                                        echo "<td>" . $data['alamat_asal'] .  "</td>";
                                                        echo "<td>" . $data['alasan_pindah'] . "</td>";
