                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Laporan Cetak Izin Keramaian</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div style="margin:5px 0 5px 60px;">
                                <form method="get" action="lap_izin.php">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['izin'])) // Jika user mengisi izin tanggal, maka munculkan tombol untuk reset izin
                                        echo '<a href="lap_izin.php" style="padding:9px; background-color:#ff6e00; color:#fff; border-radius:6px; margin-left:18px;"><b>RESET</b></a>';
                                    ?>
