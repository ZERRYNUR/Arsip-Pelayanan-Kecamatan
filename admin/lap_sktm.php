                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div style="margin:5px 0 5px 60px;">
                                <form method="get" action="lap_sktm.php">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['izin'])) // Jika user mengisi izin tanggal, maka munculkan tombol untuk reset izin
                                        echo '<a href="lap_sktm.php" style="padding:9px; background-color:#ff6e00; color:#fff; border-radius:6px; margin-left:18px;"><b>RESET</b></a>';
                                    ?>
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    $query = "SELECT * FROM sktm";
                                    $url_cetak = 'print_lap_sktm.php';
                                    $label = "Semua Data Transaksi";
                                } else { // Jika terisi
                                    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                                    $query = "SELECT * FROM sktm WHERE (tanggal BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
                                    $url_cetak = "print_lap_sktm.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
