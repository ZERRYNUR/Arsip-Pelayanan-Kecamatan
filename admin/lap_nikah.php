                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Laporan Cetak Dispensasi Nikah</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Izin</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Acara</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 style="margin-bottom: 5px;"><b>Data Izin</b></h4>
                            </div>
                            <h4 style="margin-left:48px;">Filter Tanggal</h4>
                            <div style="margin:5px 0 5px 60px;">
                                <form method="get" action="lap_nikah.php">
                                    <div class="row">
                                    ...
                                    <button type="submit" name="izin" value="true" class="btn" style="background-color:#0cff00; color:#fff;"><b>TAMPILKAN</b></button>
                                    <?php
                                    if (isset($_GET['izin'])) // Jika user mengisi izin tanggal, maka munculkan tombol untuk reset izin
                                        echo '<a href="lap_nikah.php" style="padding:9px; background-color:#ff6e00; color:#fff; border-radius:6px; margin-left:18px;"><b>RESET</b></a>';
                                    ?>
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    $query = "SELECT * FROM dispen_nikah";
                                    $url_cetak = 'print_lap_nikah.php';
                                    $label = "Semua Data Transaksi";
                                } else { // Jika terisi
                                    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                                    $query = "SELECT * FROM dispen_nikah WHERE (tanggal BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
                                    $url_cetak = "print_lap_izin.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
                                            ...
                                            <tbody>
                                                ...
                                                if ($row > 0) { // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                                                    while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
                                                        ...
                                                        echo "<td>" . $data['no_pengantar'] . "</td>";
                                                        echo "<td>" . $data['nama_suami']  . '<br/>' . $data['alamat_suami'] . "</td>";
                                                        echo "<td>" . $data['nama_istri'] . '<br/>' . $data['alamat_istri'] . "</td>";
                                                        echo "<td>" . $data['tempat_nikah'] . "</td>";
                                                        echo "<td>" . $tgl . "</td>";
