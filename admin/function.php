...
if (isset($_POST['add_user'])) {
    ...
    $adduser = mysqli_query($koneksi, "INSERT INTO user (nama, user_name, password, level) VALUES ('$nama','$user_name','$password','pegawai')");
...
if (isset($_POST['edit_user'])) {
    ...
    $edit_user = mysqli_query($koneksi, "UPDATE user set nama='$nama', user_name='$user_name', password='$password' where id_user ='$id_user' and level='pegawai'");
...
if (isset($_POST['editadmin'])) {
    ...
    $edit_admin = mysqli_query($koneksi, "UPDATE user set nama='$nama', user_name='$user_name', password='$password' where id_user ='$id_user' and level='admin'");
...
if (isset($_POST['add_datang'])) {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        // maka tambahkan ke folder assets
        if (move_uploaded_file($file_tmp, "$folder")) {
            $query  = mysqli_query($koneksi, "INSERT INTO kedatangan VALUES('', '$no_pindah','$nik','$nama','$alamat_asal','$alamat_tujuan','$stat','$tanggal','$keterangan','$berkas')");
            if ($query) {
                echo '<script>alert("File berhasil di upload!");</script>';
            }
        }
