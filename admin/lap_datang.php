                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Laporan Cetak Kedatangan Penduduk</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Perpindahan</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Datang</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div style="margin:5px 0 5px 60px;">
                                <form method="get" action="lap_datang.php">
                                    <div class="row">
                                    ...
                                    if (isset($_GET['izin'])) // Jika user mengisi izin tanggal, maka munculkan tombol untuk reset izin
                                        echo '<a href="lap_datang.php" style="padding:9px; background-color:#ff6e00; color:#fff; border-radius:6px; margin-left:18px;"><b>RESET</b></a>';
                                    ?>
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    $query = "SELECT * FROM kedatangan";
                                    $url_cetak = 'print_lap_datang.php';
                                    $label = "Semua Data Transaksi";
                                } else { // Jika terisi
                                    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                                    $query = "SELECT * FROM kedatangan WHERE (tanggal BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
                                    $url_cetak = "print_lap_datang.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
